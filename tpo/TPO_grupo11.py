...
def muestraTablero(matriz):
    ...
    # Encabezado
    frase = ("¡Cuidado con las minas!")
    encabezado = frase.center(36)
    print(encabezado)
    print("_"*36)
    tam = len(matriz)
    linea = ""
...
def mina(base, jugador, puntaje, mov, fila, columna):
    ...
    print("Tu puntaje total:" + str(puntaje))
...
def main():
    ...
    print("Veamos cuantos puntos consigues antes de encontrarte con una mina,")
    print("¿Comenzamos?\n\n")
    ...
    while sigueJugando:
        ...
        sigueJugando, puntos, movimientos = checkTablero(
            tableroBase, tableroJugador, puntaje, mov, fila, columna)
